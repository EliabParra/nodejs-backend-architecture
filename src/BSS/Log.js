                ...
                switch (params.type) {
                    case this.TYPE_ERROR:
                        if (this.activation[0])
                            console.log(
                                '[MESSAGE]: '.white + `${params.msg}${ctxText} - TYPE: Error`.red
                            )
                        break
                    case this.TYPE_WARNING:
                        if (this.activation[3])
                            console.log(
                                '[MESSAGE]: '.white +
                                    `${params.msg}${ctxText} - TYPE: Warning`.yellow
                            )
                        break
                    case this.TYPE_INFO:
                        if (this.activation[1])
                            console.log(
                                '[MESSAGE]: '.white + `${params.msg}${ctxText} - TYPE: Info`.blue
                            )
                        break
                    case this.TYPE_DEBUG:
                        if (this.activation[2])
                            console.log(
                                '[MESSAGE]: '.white +
                                    `${params.msg}${ctxText} - TYPE: Debug`.magenta
                            )
                        break
                }
                break
